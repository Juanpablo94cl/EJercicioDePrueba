...
//JP/ Tratatar siempre de plantear el problema de manera verbal, con "mis" palabras, por otra parte, desglosar el problema en partes pequeñas ayuda a progresar en el problema.///
...
//JP// No necesariamente esta en orden, este listado es ejemplo de como ver el problema y un paso a paso estimado de que acciones tomar, ademas de definir cuales son nuestras variables y constantes///
...
//JP// Ojo piojo con las constantes y variables!!!///

//le pedimos la cantidad de alumnos al usuario

let cantAlumnos = parseInt(prompt("Ingrese numero de Alumnos: "));

//vamos a pedir al usuario que ingrese una nota por cada alumno

for (let i = 1; i <= cantAlumnos; i++) {
  
  //definimos la variable en donde guardaremos la nota.
  //JP// en este caso la variable la llamamos "notaAlumno" esta se iguala a "0" en un comienzo para primero declara la "funcion o comando", luego, cuando se "aplica o corre" la funcion se "cambia" por la variable que estamos usando (al igual que en funciones matematicas!!!! Plantea el algebra bien antes de empezar con la funcion).
